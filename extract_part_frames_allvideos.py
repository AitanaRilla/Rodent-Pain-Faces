...
def procesar_carpeta(carpeta_path):
    ...
    for nombre_fichero_mp4 in [f for f in archivos if f.endswith(".mp4")]:
        ...
        #Search for the corresponding .h5 file
...
body_parts = {
    ...
    'Ojo_derecho': ((0, 255, 0), 50),   #'Right eye', Green, size 50
}

root_path = "/Users/aitanarilla/Desktop/Modelo_caras/Files"
procesar_video_y_h5(root_path, max_nivel=3)  #Change max_level if you need it
